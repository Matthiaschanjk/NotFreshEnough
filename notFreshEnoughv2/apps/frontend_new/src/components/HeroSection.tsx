  ...
  return (
    <section className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,1fr)_460px] lg:items-center">
      <div className="max-w-2xl">
        <p className="font-body text-xs uppercase tracking-[0.3em] text-ink/45">NotFreshEnough</p>
        ...
        <p className="mt-6 max-w-xl font-body text-lg leading-8 text-ink/72">
          NotFreshEnough inspects your repo, demo, docs, and whatever other public surface you hand over. Then one click
